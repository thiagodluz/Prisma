...
- Espectro trocado com uma pedra elimina a cor dela; dois Espectros trocados eliminam o tabuleiro inteiro. Um Espectro atingido indiretamente procura a pedra colorida mais próxima na mesma linha, à esquerda e à direita. Em caso de empate na distância, usa a cor da esquerda. Se não houver pedra colorida nessa linha, o Espectro não elimina nenhuma cor adicional. São escolhas próprias do Prisma, a reavaliar após jogar no Android.
...
- Clássico e Zen começam com meta de 1.800 pontos; na versão 1.0.1, ela cresce somente 150 por nível até alcançar 4.650 no nível 20 e depois fica fixa. Sem jogadas, Clássico encerra e Zen põe um Espectro no centro ou na primeira casa comum disponível, mantendo as demais pedras. Na versão 1.0, subir de nível embaralha automaticamente as pedras existentes nos dois modos, preserva as especiais e garante jogada válida sem combinações prontas. O embaralhamento manual fica exclusivo do Zen. Ao trocar de modo, cada partida salva permanece intacta.
