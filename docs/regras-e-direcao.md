...
- Clássico e Zen começam com meta de 1.800 pontos; ela cresce 350 por nível até 5.300. Sem jogadas, Clássico encerra e Zen põe um Espectro no centro ou na primeira casa comum disponível, mantendo as demais pedras. Na versão 1.0, subir de nível embaralha automaticamente as pedras existentes nos dois modos, preserva as especiais e garante jogada válida sem combinações prontas. O embaralhamento manual fica exclusivo do Zen. Ao trocar de modo, cada partida salva permanece intacta.
